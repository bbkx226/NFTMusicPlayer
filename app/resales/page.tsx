          ...
          <div className="px-5 w-full">
            ...
            <div className="glass">
              ...
              >
                ...
                <div className="absolute top-1/2 z-10 left-0 transform -translate-y-1/2 -translate-x-full flex items-center justify-center">
                  <div className="swiper-button-prev w-10 h-10 rounded-full shadow-lg"></div>
                </div>

                <div className="absolute top-1/2 z-10 right-0 transform -translate-y-1/2 translate-x-full flex items-center justify-center">
                  <div className="swiper-button-next w-10 h-10 rounded-full shadow-lg"></div>
                </div>
              </Swiper>
            </div>
            <div className="glass w-full mt-4">
              ...
              >
                {completedSales && completedSales.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 py-3">
                    {completedSales.map((item, idx) => (
                      <SwiperSlide
                        className="relative glass grid grid-rows-3 hover:shadow-cyan-600 shadow-lg rounded-lg w-148 h-168 md:w-72 md:h-96 lg:w-92 lg:h-104"
                        key={idx}
                ...
                <div className="absolute top-1/2 z-10 left-0 transform -translate-y-1/2 -translate-x-full flex items-center justify-center">
                  <div className="swiper-button-prev w-10 h-10"></div>
                </div>

                <div className="absolute top-1/2 z-10 right-0 transform -translate-y-1/2 translate-x-full flex items-center justify-center">
                  <div className="swiper-button-next w-10 h-10"></div>
                </div>
              </Swiper>
            </div>
          </div>
