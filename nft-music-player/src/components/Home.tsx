        ...
        <div className="row">
          <main role="main" className="mx-auto" style={{ maxWidth: '500px' }}>
            <div className="content mx-auto">
              ...
              <div className="card">
                <div className="card-header">{currentItemIndex + 1} of {marketItems.length}</div>
                <img className="card-img-top" src={marketItems[currentItemIndex].identicon} />
                ...
                <div className="card-footer">
                  <div className='d-grid my-1'>
                    <button onClick={() => buyMarketItem(marketItems[currentItemIndex])} className="btn btn-primary btn-lg">
